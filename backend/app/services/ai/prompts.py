...
def build_system_instruction(user_name: Optional[str] = None, lang: str = "es", clinic_name: Optional[str] = None, user_role: Optional[str] = None) -> str:
    ...
    system_instruction = (
        ...
        "- Ajustes, configuración o perfil -> /dashboard/settings (puedes añadir ?tab=pestana como parámetro de consulta para abrir una pestaña específica directamente, por ejemplo: ?tab=branding para abrir la Identidad de Marca)\n"
