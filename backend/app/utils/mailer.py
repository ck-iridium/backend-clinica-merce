...
def send_appointment_notification(db: Session, appointment: models.Appointment, type: str):
    """
    ...
    if type == 'new_web_booking':
        ...
        """
        send_email(db, client.email, subject_client, body_client)
        ...
        if settings.clinic_email:
            ...
            """
            send_email(db, settings.clinic_email, subject_clinic, body_clinic)
        ...
        """
        send_email(db, client.email, subject, body)
