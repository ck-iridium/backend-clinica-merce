  ...
  return (
    <div className="space-y-8 md:space-y-10 animate-in slide-in-from-bottom-2 duration-300 font-sans w-full">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 items-start">
        ...
        {/* ── TARJETA: LOGOTIPO PARA MÓVILES (HEADER MOBILE) — OPCIONAL ── */}
        <div className="xl:col-span-12 bg-white rounded-3xl border border-stone-200/70 p-6 md:p-8 shadow-sm space-y-6 hover:shadow-md transition-all duration-300">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-stone-100 pb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-base font-bold text-stone-900">Logotipo para Móvil (Header Mobile)</h4>
                <p className="text-[10px] text-stone-400 font-bold uppercase tracking-wider mt-0.5">Isotipo o versión compacta para smartphones y tablets pequeñas</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-5 space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  {settings.logo_mobile_b64 ? 'Cambiar Logotipo Móvil' : 'Subir Logotipo para Móvil'}
                </button>
                {settings.logo_mobile_b64 && (
                  <button
                    type="button"
                    ...
                    title="Volver a heredar el logotipo principal de cabecera"
                  >
                    Usar Cabecera
                  </button>
                )}
            ...
            <div className="lg:col-span-7 space-y-5 bg-stone-50/70 border border-stone-200/60 rounded-2xl p-5 md:p-6">
              ...
              <div className="flex items-center gap-2 text-stone-800 font-bold text-xs uppercase tracking-wider border-b border-stone-200/60 pb-3">
                <SlidersHorizontal size={15} className="text-[#d4af37]" />
                <span>Calibración Específica para Móvil</span>
              </div>
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center text-xs">
                  <span className="font-bold text-stone-700 flex items-center gap-1.5">
                    <Maximize2 size={13} className="text-stone-400" />
                    Altura Máxima en Pantallas Móviles
                  </span>
                  <div className="flex items-center gap-1.5">
              ...
              <div className="space-y-2 pt-2 border-t border-stone-200/50">
                <div className="flex justify-between items-center text-xs">
                  <span className="font-bold text-stone-700 flex items-center gap-1.5">
                    <Sun size={13} className="text-stone-400" />
                    Color del Logotipo Móvil (Dark / Light)
                  </span>
                  <span className="text-stone-400 text-[11px] font-medium">
                    {mobileLogoMode === 'white' ? 'Blanco Puro' : mobileLogoMode === 'adaptive' ? 'Adaptativo' : 'Original'}
                  </span>
                </div>
                <div className="grid grid-cols-3 gap-2">
                  <button
                ...
                <p className="text-[11px] text-stone-400 leading-tight">
                  <strong className="text-stone-600">Adaptativo</strong> muestra el isotipo en blanco nítido sobre la portada móvil y en color original durante el scroll.
                </p>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 bg-amber-50/70 rounded-xl border border-amber-200/50 text-xs text-amber-900 leading-relaxed">
                ...
                <span>
                  <strong>Recomendación Quiet Luxury:</strong> En pantallas móviles de 360-400px de ancho, un isotipo o símbolo cuadrado/circular proporciona una jerarquía mucho más limpia junto al menú. Si no se sube uno, se usará el logotipo de cabecera principal.
                </span>
              </div>
        ...
        {/* ── TARJETA: LOGOTIPO DEL PIE DE PÁGINA (FOOTER) — OPCIONAL ── */}
        <div className="xl:col-span-12 bg-white rounded-3xl border border-stone-200/70 p-6 md:p-8 shadow-sm space-y-6 hover:shadow-md transition-all duration-300">
