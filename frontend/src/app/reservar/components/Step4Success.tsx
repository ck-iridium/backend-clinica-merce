    ...
    <div className="w-full flex flex-col flex-grow bg-[#F7F7F5] items-center justify-center px-6 overflow-y-auto py-12 md:py-24">
      ...
      >
        <div className="p-6 md:p-8 md:px-10 border-b border-stone-50">
          ...
          <div className="space-y-4 md:space-y-6">
            <div className="flex items-center gap-4 md:gap-6">
              ...
              <div>
                <p className="text-[10px] md:text-xs uppercase font-bold text-stone-400">{t('common.date')}</p>
            ...
            <div className="flex items-center gap-4 md:gap-6">
              ...
              <div>
                <p className="text-[10px] md:text-xs uppercase font-bold text-stone-400">{t('common.time')}</p>
        ...
        <div className="bg-stone-50/50 p-6 md:p-8 md:px-10 flex items-center justify-between">
          <div className="flex flex-col">
            <p className="text-[10px] md:text-xs font-black uppercase text-stone-400 tracking-widest mb-0.5">{t('common.treatment')}</p>
      ...
      >
        ...
        <p className="text-xs md:text-sm text-stone-500 leading-relaxed">
          {t('success.emailNote1')} <span className="text-stone-800 font-bold">{t('success.emailNoteTime')}</span> {t('success.emailNote2')}
        </p>
      </motion.div>
