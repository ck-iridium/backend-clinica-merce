...
function getTooltipTextForId(id: string): string {
  const dictionary: Record<string, string> = {
    ...
    'beauty-skin-type-input': 'Tipo de piel, fototipo o sensibilidad dérmica.',
    'beauty-cosmetic-sensitivities-input': 'Reacciones o alergias a cosméticos, cremas o activos.',
    'beauty-aesthetic-notes-textarea': 'Tratamientos de interés, objetivos estéticos o notas.',
    'barber-hair-type-input': 'Textura del cabello, densidad, estado del cuero cabelludo.',
    'barber-chemical-sensitivities-input': 'Reacciones a tintes, amoníaco u otros químicos.',
    'barber-color-formulas-textarea': 'Fórmulas para coloraciones, tintes o tratamientos capilares.',
